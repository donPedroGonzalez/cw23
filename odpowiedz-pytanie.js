var questionsToFind, answersProvided, hints;
...
{   
    ...
    document.getElementById("premiere-consigne").innerText = questionsToFind[0];
    document.getElementById("deuxieme-consigne").innerText = answersProvided[0];
    document.getElementById("footer-cat-info").innerText = hints[0];

    // Creating a form with questions, inputs and hints
    var newItemLabel, newItemInput, prefixToQuestion, suffixToQuestion;

    for(var i = 1; i < questionsToFind.length; i++)
    {
        prefixToQuestion = document.createElement("span");
        prefixToQuestion.innerText = " – ";
        ...
        suffixToQuestion = document.createElement("span");
        suffixToQuestion.innerText = " ?";
        var paragraph = document.createElement("p");        
        paragraph.setAttribute("id", "par" + i);
        paragraph.appendChild(prefixToQuestion);
        paragraph.appendChild(newItemInput);
        paragraph.appendChild(suffixToQuestion);
        ...
        newItemLabel.innerText = answersProvided[i] + "  ";
    ...
    var answerBad, itemName, itemToCheck, formToCheck, myparagraph, resultWrapper;
    var correctAnswer = "";
    var correctNumber = 0;
    ...
    document.getElementById("button").onclick = function()
    {
        ...
        for(var i = 1; i < questionsToFind.length; i++)
        {
            ...
            answers = questionsToFind[i].split("|");
            itemName = "item" + i;
            ...
            resultWrapper.innerText = "Ton résultat : " + correctNumber + " / " + Number(questionsToFind.length-1);
...
{
    for(var i = 1; i < answersProvided.length; i++)
    {
        filledIn = true;
        itemName = "item" + i;
        formToCheck = document.getElementById("myExercice");
